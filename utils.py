...
if path.exists(f"{guild_id}.json"):
    ...
    with open(f"{guild_id}.json", "r") as file: 
        ...
        add_win(guild_id=guild_id, players=radiant, stats=stats)
        subtract_loss(guild_id=guild_id, players=radiant, stats=stats)

        add_loss(guild_id=guild_id, players=dire, stats=stats)
        subtract_win(guild_id=guild_id, players=dire, stats=stats)
